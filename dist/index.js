...
function hugoPlugin({ hugoOutDir, appDir, ignoreHTMLFiles = [], hugoConfigFileName = "hugo.toml", }) {
    const hugoConfig = (0, utils_1.getHugoConfig)(appDir, hugoConfigFileName);
    ...
    const hugo = {
        ...
        config: () => ({
            ...
            build: {
                ...
                rollupOptions: {
                    // Routing
                    input: (0, utils_1.getHtmlPages)(hugoOutDir, [
                        ...ignoreBuildPaths,
                        ...ignoreHTMLFiles,
                    ]),
                },
